...
def login():
    #LOGIN NOW 90 SECS
    driver.find_element_by_id("fld-e").send_keys("aaronwheatley326@gmail.com")
    driver.find_element_by_id("fld-p1").send_keys("Aaronw0302")
...
def addToCart(id):
    ...
    elem[0].click()
    driver.implicitly_wait(2)
    driver.find_element_by_id("credit-card-cvv").send_keys("246")
...
def checkInStock():
    ...
    global elem
    global driver
    driver.get("https://www.bestbuy.com/site/asus-geforce-rtx-3080-10gb-gddr6x-pci-express-4-0-strix-graphics-card-black/6432445.p?skuId=6432445")
